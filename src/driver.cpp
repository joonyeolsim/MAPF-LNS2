...
int main(int argc, char** argv) {
  ...
  desc.add_options()("help", "produce help message")
      ...
      ("map,m", po::value<string>()->required(), "input file for map")(
          "agents,a", po::value<string>()->default_value("0"), "input file for agents")(
          ...
          "screen option (0: none; 1: LNS results; 2:LNS detailed results; 3: MAPF detailed "
          "results)")("stats", po::value<string>(), "output stats file")
  ...
  for (int t = 0; t < 100; t++) {
    ...
    if (vm["solver"].as<string>() == "LNS") {
      LNS lns(instance, time_limit, vm["initAlgo"].as<string>(), vm["replanAlgo"].as<string>(),
              vm["destoryStrategy"].as<string>(), vm["neighborSize"].as<int>(),
