...
InitLNS::InitLNS(const Instance&instance, vector<Agent>&agents, double time_limit,
                 ...
                 int screen) : BasicLNS(instance, time_limit, neighbor_size, screen), agents(agents),
...
void InitLNS::chooseDestroyHeuristicbyALNS() {
    ...
    switch (selected_neighbor) {
        case 0: init_destroy_strategy = TARGET_BASED;
            break;
        case 1: init_destroy_strategy = COLLISION_BASED;
            break;
        case 2: init_destroy_strategy = RANDOM_BASED;
            break;
